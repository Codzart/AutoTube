...
> This code will show you how to set up a fully automated YouTube Channel.
> Content is gathered from Reddit using both animated and still images.
> Setup is in-depth at times so check out the tutorial video if you need extra help.

## Setup
- Clone Project
- pip install -r requirements.txt 
- This project uses MoviePy which uses <a href='https://www.imagemagick.org/script/index.php'>ImageMagick</a> to write text onto our movie. Follow the link to install. Not on Windows?  You will need to update the config defaults. 
